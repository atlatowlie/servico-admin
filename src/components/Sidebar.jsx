...
const links = [
  ...
  { to: '/twilio-settings', label: 'Twilio Settings', icon: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  { to: '/call-recordings-backfill', label: 'Call Recordings', icon: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/>
    </svg>
  )},
  { to: '/sms-reconciliation', label: 'SMS Reconciliation', icon: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <aside className="h-full bg-surface border-r border-slate-700 flex flex-col">
      <div className="flex items-center justify-between p-4 border-b border-slate-700">
        ...
        <button onClick={onClose} className="p-2 text-[var(--app-muted)] hover:text-[var(--app-text)] md:hidden rounded-lg active:bg-surface2" aria-label="Close menu">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-colors ${
                isActive ? 'bg-emerald-500/15 text-emerald-400 font-medium' : 'text-[var(--app-muted)] hover:text-[var(--app-text)] hover:bg-surface2 active:bg-surface2'
              }`
            }
          >
      ...
      <div className="p-3 border-t border-slate-700">
        ...
        <button
          ...
          className="w-full text-left px-3 py-2.5 text-sm text-red-500 hover:bg-red-500/10 active:bg-red-500/15 rounded-lg transition-colors"
        >
          Logout
        </button>
      </div>
